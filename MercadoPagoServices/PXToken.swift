...
open class PXToken: NSObject, Codable {
    ...
    required public convenience init(from decoder: Decoder) throws {
        ...
        let usedDate: Date? = try container.decodeDateFromStringIfPresent(String.self, forKey: .usedDate)
        ...
        let dueDate: Date? = try container.decodeDateFromStringIfPresent(String.self, forKey: .dueDate)
